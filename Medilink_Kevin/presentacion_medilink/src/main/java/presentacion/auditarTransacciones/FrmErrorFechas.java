 ...
 * @author keppler
 */
public class FrmErrorFechas extends StackPane {

    public FrmErrorFechas(Runnable alVolver) {
        setStyle("-fx-background-color: rgba(0,0,0,0.45);");
        setPrefSize(950, 560);

        Label titulo = new Label("Rango de fechas inválido");
        titulo.setStyle("-fx-font-size: 30px; -fx-font-weight: bold;");

        Label msg = new Label("Verifica las fechas de inicio y fin");
