 ...
 * @author keppler
 */
public class FrmFacturaNoEmitida extends StackPane {

    public FrmFacturaNoEmitida(Runnable alVolver) {
        setStyle("-fx-background-color: rgba(0,0,0,0.45);");
        setPrefSize(950, 560);

        Label titulo = new Label("Factura no emitida");
        titulo.setStyle("-fx-font-size: 30px; -fx-font-weight: bold;");

        Label msg = new Label("Esta transacción no tiene un pago "+ "registrado en el sistema externo");
