 ...
 * @author keppler
 */
public class FrmDatosFaltantes extends StackPane {

    public FrmDatosFaltantes(Runnable alVolver) {
        setStyle("-fx-background-color: rgba(0,0,0,0.45);");
        setPrefSize(950, 560);

        Label titulo = new Label("Datos faltantes");
        titulo.setStyle("-fx-font-size: 32px; -fx-font-weight: bold;");

        Label msg = new Label("Completa todos los campos requeridos");
