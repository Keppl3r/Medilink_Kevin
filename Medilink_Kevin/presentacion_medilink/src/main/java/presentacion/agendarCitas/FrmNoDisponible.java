 ...
 * @author keppler
 */
public class FrmNoDisponible extends StackPane {

    public FrmNoDisponible(Runnable alVolver) {
        setStyle("-fx-background-color: rgba(0,0,0,0.45);");
        setPrefSize(950, 560);

        Label titulo = new Label("No Disponible");
        titulo.setStyle("-fx-font-size: 34px; -fx-font-weight: bold;");

        Label msg = new Label("El especialista no está disponible "
                + "en este momento");
