 ...
 * @author keppler
 */
public class FrmDatosErroneos extends StackPane {

    public FrmDatosErroneos(Runnable alVolver) {
        setStyle("-fx-background-color: rgba(0,0,0,0.45);");
        setPrefSize(950, 560);

        Label titulo = new Label("Datos erróneos");
        titulo.setStyle("-fx-font-size: 32px; -fx-font-weight: bold;");

        Label msg = new Label("Los datos ingresados no son correctos");
